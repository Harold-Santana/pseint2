...
// y 6min en el C. la cantidad de exámenes de cada tipo se entran por teclado.
...
//Ingrese un número entero y reporte si es par o impar.
...
// cuya compra es mayor a los $100. ¿Cuál será la cantidad que 
...
//Leer 2 números; si son iguales que  los multiplicamos , si el primero es mayor
...
// Leer 3 números diferentes e imprimir el número mayor de los 3
...
// Una fruteria ofrece las manzanas con descuento según la siguiente
...
// Determinar cuánto pagará una persona que compre las manzanas.
...
// Bodas de Hojuelas=10años
// Bodas de Porcelana=20años 
// Bodas de Perlas=30años
// Bodas de Rubi=40años
// Bodas de Oro=50años
// Bodas de Diamante=60años
...
// OPción1: Elevar un número a un exponente x
...
// de las lista, cuántos números pares existen y cual es el 
